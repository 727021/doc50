...
# Submitting CS50 Assignments with Git

<Callout type="info">
    Already have git installed and set up? Skip to [Submitting Your CS50 Assignment](#submitting-your-cs50-assignment).
</Callout>
...
<Callout type="info">
    Make sure to replace the following in the commands below:

    - Replace `USERNAME` with your GitHub username.
    - Replace `the/branch/from/the/assignment` with the branch from the assignment's _How to Submit_ instructions (i.e. `web50/projects/2020/x/search`)
</Callout>
